...
```javascript
SECONDS_IN_HOUR = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-hour@v0.3.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-time-seconds-in-hour@v0.3.2-umd/browser.js"></script>
```
